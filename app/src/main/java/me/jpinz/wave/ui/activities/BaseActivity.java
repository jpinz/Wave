...
import static me.jpinz.wave.utils.MusicUtils.mService;
...
import me.jpinz.wave.IWaveService;
import me.jpinz.wave.MusicPlaybackService;
...
import me.jpinz.wave.utils.NavUtils;
...
public abstract class BaseActivity extends FragmentActivity implements ServiceConnection {
    ...
    public void onServiceConnected(final ComponentName name, final IBinder service) {
        mService = IWaveService.Stub.asInterface(service);
    ...
    protected void onPause() {
        ...
        if (MusicUtils.isPlaying()) {
            if (WaveUtils.isApplicationSentToBackground(this) || mIsBackPressed
    ...
    private void updateBottomActionBarInfo() {
        ...
        // Set the album art
        WaveUtils.getImageFetcher(this).loadCurrentArtwork(mAlbumArt);
    }
