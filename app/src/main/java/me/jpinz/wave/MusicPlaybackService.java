...
import me.jpinz.wave.utils.SharedPreferencesCompat;
...
public class MusicPlaybackService extends Service {
     ...
     */
    public static final String PLAYSTATE_CHANGED = "me.jpinz.wave.playstatechanged";

    /**
     * Indicates the meta data has changed in some way, like a track change
     */
    public static final String META_CHANGED = "me.jpinz.wave.metachanged";

    /**
     * Indicates the queue has been updated
     */
    public static final String QUEUE_CHANGED = "me.jpinz.wave.queuechanged";

    /**
     * Indicates the repeat mode chaned
     */
    public static final String REPEATMODE_CHANGED = "me.jpinz.wave.repeatmodechanged";

    /**
     * Indicates the shuffle mode chaned
     */
    public static final String SHUFFLEMODE_CHANGED = "me.jpinz.wave.shufflemodechanged";

    /**
     * Called to indicate a general service commmand. Used in
     * {@link MediaButtonIntentReceiver}
     */
    public static final String SERVICECMD = "me.jpinz.wave.musicservicecommand";

    /**
     * Called to go toggle between pausing and playing the music
     */
    public static final String TOGGLEPAUSE_ACTION = "me.jpinz.wave.togglepause";

    /**
     * Called to go to pause the playback
     */
    public static final String PAUSE_ACTION = "me.jpinz.wave.pause";

    /**
     * Called to go to stop the playback
     */
    public static final String STOP_ACTION = "me.jpinz.wave.stop";

    /**
     * Called to go to the previous track
     */
    public static final String PREVIOUS_ACTION = "me.jpinz.wave.previous";

    /**
     * Called to go to the next track
     */
    public static final String NEXT_ACTION = "me.jpinz.wave.next";

    /**
     * Called to change the repeat mode
     */
    public static final String REPEAT_ACTION = "me.jpinz.wave.repeat";

    /**
     * Called to change the shuffle mode
     */
    public static final String SHUFFLE_ACTION = "me.jpinz.wave.shuffle";

    /**
     * Called to kill the notification while Apollo is in the foreground
     */
    public static final String KILL_FOREGROUND = "me.jpinz.wave.killforeground";

    /**
     * Used to easily notify a list that it should refresh. i.e. A playlist
     * changes
     */
    public static final String REFRESH = "me.jpinz.wave.refresh";

    /**
     * Called to build the notification while Apollo is in the background
     */
    public static final String START_BACKGROUND = "me.jpinz.wave.startbackground";

    /**
     * Called to update the remote control client
     */
    public static final String UPDATE_LOCKSCREEN = "me.jpinz.wave.updatelockscreen";
    ...
    public void buildNotification() {
        if (mBuildNotification || WaveUtils.isApplicationSentToBackground(this)) {
            try {
    ...
    private static final class ServiceStub extends IWaveService.Stub {
